document.addEventListener("DOMContentLoaded", async function(){
    ...
    // a layer group is also a layer, but it's to purpose other layers
    ...
    // base layer - only 1 active at a time (radio button, mutually exclusive)
    // overlay layer - more than 1 can be active at the same time (checkboxes)
